...
namespace mercadopago
{
    ...
    public class MP
    {
        ...
        /// </summary>
        /// <param name="ll_access_token"></param>
        ...
        public async Task<Hashtable>  getPaymentAsync(String id)
        {
            ...
            Hashtable paymentInfo = await RestClient.getAsync("/v1/payments/" + id + "?access_token=" + accessToken);
        ...
        public async Task<Hashtable> refundPaymentAsync(String id)
        {
            ...
            Hashtable response = await RestClient.postAsync("/v1/payments/" + id + "/refunds?access_token=" + accessToken, refundStatus);
        ...
        public async Task<Hashtable>  cancelPaymentAsync(String id)
        {
            ...
            Hashtable response = await RestClient.putAsync("/v1/payments/" + id + "?access_token=" + accessToken, cancelStatus);
        ...
        public async Task<Hashtable> searchPaymentAsync(Dictionary<String, String> filters, long offset = 0, long limit = 0)
        {
            ...
            Hashtable collectionResult = await RestClient.getAsync("/v1/payments/search?" + filtersQuery + "&access_token=" + accessToken);
            return collectionResult;
        }
        ...
        public async Task<Hashtable> createPreferenceAsync(String preference)
        {
            Hashtable preferenceJSON = (Hashtable)JSON.JsonDecode(preference);
            return await this.createPreferenceAsync(preferenceJSON);
        }
        ...
        /// <param name="authenticate"></param>
        /// <returns></returns>
        public Task<Hashtable> getAsync(String uri, bool authenticate)
        {
            return this.getAsync(uri, null, authenticate);
        }
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public Task<Hashtable> getAsync(String uri, Dictionary<String, String> parameters)
        {
            return this.getAsync(uri, parameters, true);
        }
        ...
        public Task<Hashtable> postAsync(String uri, String data)
        {
            return this.postAsync(uri, data, null);
        }
        ...
        public Task<Hashtable> postAsync(String uri, String data, Dictionary<String, String> parameters)
        {
            Hashtable dataJSON = (Hashtable)JSON.JsonDecode(data);
            return this.postAsync(uri, dataJSON, parameters);
        }
        ...
        public Task<Hashtable> postAsync(String uri, Hashtable data)
        {
            return this.postAsync(uri, data, null);
        }
        ...
        public Task<Hashtable> postAsync(String uri, Hashtable data, Dictionary<String, String> parameters)
        {
            if (parameters == null)
            {
                parameters = new Dictionary<String, String>();
            ...
            {
                return Task.Run(() => (Hashtable)JSON.JsonDecode(e.Message));
            }
            ...
            return RestClient.postAsync(uri, data);
        }
        ...
        /// <param name="uri"></param>
        /// <returns></returns>
        public Task<Hashtable> deleteAsync(String uri)
        {
            return this.deleteAsync(uri, null);
        }
        ...
        private static class RestClient
        {
            ...
            {
                Hashtable response;
                HttpWebRequest request = PrepareRequest(method, uri, data, contentType);
                ...
                {
                    response = WhriteWebLog(responseBody, e);
                }
            ...
            private static async Task<Hashtable> execAsync(String method, String uri, Object data, String contentType)
            {
                ...
                try
                {
                    var apiResult = (HttpWebResponse)(await request.GetResponseAsync());
                    responseBody = new StreamReader(apiResult.GetResponseStream()).ReadToEnd();
            ...
            private static Hashtable WhriteWebLog(string responseBody, WebException e)
            {
            ...
            private static HttpWebRequest PrepareRequest(string method, string uri, object data, string contentType)
            {
                HttpWebRequest request = (HttpWebRequest)WebRequest.Create(API_BASE_URL + uri);

                request.UserAgent = "MercadoPago .NET Core SDK v" + MP.version;
            ...
            public static Task<Hashtable> getAsync(String uri, String contentType = MIME_JSON)
            {
                return execAsync("GET", uri, null, contentType);
            }
            #endregion
            ...
            public static Task<Hashtable> postAsync(String uri, Object data, String contentType = MIME_JSON)
            {
                return execAsync("POST", uri, data, contentType);
            }
            #endregion
            ...
            public static Task<Hashtable> putAsync(String uri, Object data, String contentType = MIME_JSON)
            {
                return execAsync("PUT", uri, data, contentType);
            }
            #endregion
            ...
            public static Task<Hashtable> deleteAsync(String uri, String contentType = MIME_JSON)
            {
                return execAsync("DELETE", uri, null, contentType);
            }
            #endregion
        }
    }
